...
![Figure 1: Different layers involved when using JPF](https://github.com/javapathfinder/jpf-core/blob/master/docs/graphics/jpf-layers.svg){align=center width=700}
...
![Figure 2: JPF infrastructure](https://github.com/javapathfinder/jpf-core/blob/master/docs/graphics/jpf-intro-new.svg){align=center width=800}
